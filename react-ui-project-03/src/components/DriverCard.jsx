    ...
    <div className="w-full flex flex-col min-h-screen">
      ...
      <section className="relative w-full min-h-screen overflow-hidde items-center justify-center n flex flex-col">
        ...
        <p className="text-lg max-w-4xl leading-relaxed">
          ...
          only team to have competed in every season since the world championship
        ...
        <div className="mt-12 grid md:grid-cols-2 gap-12">
          <div>
            ...
            <p className="text-gray-300">
              ...
              between them. Runners-up in the constructors’ standings, losing out
              to McLaren at the final round. Lewis Hamilton signed to replace
              Sainz for 2025.
            </p>
          </div>
          <div>
            ...
            <p className="text-gray-300">
              ...
              Singapore – but an otherwise frustrating campaign of mixed fortunes
              sees team narrowly lose out to Mercedes for P2 in the constructors’
              table, despite six pole positions and nine podiums.
            </p>
          </div>
        </div>
      </section>
